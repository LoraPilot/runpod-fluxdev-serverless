...
- [`dev.yml`](../.github/workflows/dev.yml): Builds and pushes the default Flux image target (`flux-dev`) for development snapshots.
- [`release.yml`](../.github/workflows/release.yml): Builds and pushes the release matrix for the targets that matter to this repo: `base`, `base-cuda12-8-1`, `base-cuda13-0`, `flux-dev`, and `flux-dev-cuda13`.
